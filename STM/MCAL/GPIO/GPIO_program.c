...
/**
 * @brief Sets all the pins for a GPIO as one of 4 pin modes: input, output, alternating function, or analogue modes.
 * @param Copy_u8PortName The port to set the pin in as. We have a choice of 3 registers: GPIO A, GPIO B, GPIO C.
...
/**
 * @brief Gets the pin value as one of 2 values: high or low.
 * @param Copy_u8PortName The port to get the pin from. We have a choice of 3 registers: GPIO A, GPIO B, GPIO C.
 * @param Copy_u8PinNum The pin in the port to get. We have a choice between 16 pins for GPIO A, 16 pins for GPIO B, and 3 pins for GPIO C.
 * @returns u8
 */
...
/**
 * @brief Sets the pin value as one of 2 values: high or low.
 * @param Copy_u8PortName The port to set the pin in as. We have a choice of 3 registers: GPIO A, GPIO B, GPIO C.
 * @param Copy_u8PinNum The pin in the port to set. We have a choice between 16 pins for GPIO A, 16 pins for GPIO B, and 3 pins for GPIO C.
 * @param Copy_u8Pinval The value to set: high or low.
 * @return void
 */
...
/**
 * @brief Sets a value for the whole port
 * @param copy_u8PortName The port to set the values in. We have a choice of 3 registers: GPIO A, GPIO B, GPIO C
 * @param Copy_u32OutputVal The value to set in the port
 */
...
/**
 * @brief Secures a given pin from being changed and its configurations are protected from being changed.
 * @param copy_u8PortName The port to set the pin in as. We have a choice of 3 registers: GPIO A, GPIO B, GPIO C.
 * @param copy_u8PinNum The pin number to lock
 */
...
/**
 * @brief Sets a pin to alternating function to allow it to be used with peripherals such as timers, UART, etc. We choose the correspinding alt function depending on the peripheral
 * @param copy_u8PortName The port to set the pin in as. We have a choice of 3 registers: GPIO A, GPIO B, GPIO C.
 * @param copy_u8PinNum The pin in the port to set. We have a choice between 16 pins for GPIO A, 16 pins for GPIO B, and 3 pins for GPIO C.
 * @param Copy_u8AltFun The choices are MGPIO_ALTFN_0, MGPIO_ALTFN_1.. to  MGPIO_ALTFN_15
 */
