 ...
 * @param Copy_uddtTMR The timer to enable
 */
 ...
 * @param Copy_uddtTMR The timer number to disable
 */
 ...
 * @param Copy_uddtTMR The timer number to set
 * @param Copy_u16Prescaler The prescaler chosen
 */
 ...
 * @param Copy_uddtTMR The timer number to set counter for
 * @param Copy_u16Count The count to set in case of using a 16 bit timer (TIM3, TIM4)
 * @param Copy_u32Count The count to set in case of a 32 bit timer (TIM2, TIM5)
 */
 ...
 * @param Copy_uddtTMR The timer number to set the autoload preload value in
 * @param Copy_u16ARR The value to set in the autoload preload register
 */
...
/**
 * @brief Gets the current count the timer has counted to
 * @param Copy_uddtTMR The timer number to get count from
 * @return u32
 */
...
/**
 *
 * @brief The CCR1 register is used to control the duty cycle of the PWM signal. The PWM output is high when the timer value is less than the CCR1 value and low otherwise. The timer repeats the cycle after reaching the period value.
 * @param Copy_uddtTMR The timer number to get CCR1 value of
 * @return u32
 */
...
/**
 * @brief Chooses which channel of which timer to set to which mode of the 7 modes
 * @details The given modes are Frozen, Active on Match, Inactive on Match, Toggle, Force Inactive, Force Active, PWM 1 and PWM 2 modes
 * @param Copy_uddtTMR_no The timer number to set channels of
 * @param Copy_uddtFn The mode to set
 * @param Copy_uddtChNo The channel number to set the mode in, chose between 1 of 4 channels
 */
 ...
 * @param Copy_uddtTMR_no The timer number you are setting value in
 * @param copy_u32CmpValue The value to set in the CCR1
 */
